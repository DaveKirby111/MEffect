...
if( !class_exists('kinacf_acf_field_post_type') ) :


class kinacf_acf_field_post_type extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Post Type', 'TEXTDOMAIN');
		...
		*  var message = acf._e('post_type', 'error');
		*/
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		// 	'instructions'	=> __('Select the post type','TEXTDOMAIN'),
		// 	'type'			=> 'select',
		// 	'name'			=> 'post_type',
		// ));
	...
	*/
	...
	function render_field( $field ) {
		...
		*/
        ...
        $exclude_list = array( 'attachment' );
        
        foreach( $post_types as $type ):
            if ( ! in_array( $type->name, $exclude_list ) ) array_push( $field['post_type'],  array( 'label' => $type->label, 'name' => $type->name ) );
        endforeach;
        ...
        <select name="<?php echo esc_attr($field['name']) ?>" id="<?php echo esc_attr($field['name']) ?>">
            <?php 
                foreach( $field['post_type'] as $post_type ): 
                    $selected = ( $field['value'] == $post_type['name'] ? 'selected' : '' );
...
// initialize
new kinacf_acf_field_post_type( $this->settings );
