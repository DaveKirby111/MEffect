<?php
    ...
    $news_item = '<div class="news-item news-item-horizontal d-flex">'.
                    ( $img_alt ? '<a href="'. get_the_permalink() .'" class="news-img col-lg-4 col-12 has-object-fit"><figure class="object-fit-image-container">'. $img_alt .'</figure></a>' : '' ) .
                    '<div class="news-info">'.
